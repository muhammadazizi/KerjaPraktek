	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center">
				...
				<div class="sidebar-brand-text mx-3">Toko Jam Surya</div>
			</a>
				...
				<div class="container-fluid">
					...
					<form method="POST" action="<?php echo base_url('admin/update') ?>">
						...
						<div class="row mb-3">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" name="nama_user" value="<?php echo $transaksi['nama_user']; ?>">
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-5">
								<input type="number" class="form-control" name="hp" value="<?php echo $transaksi['hp']; ?>">
							</div>
						</div>

						<div class="row mb-3">
							<label for="tanggal_transaksi" class="col-sm-2 col-form-label">tanggal_transaksi</label>
							<div class="col-sm-5">
								<input type="text" class="form-control" name="tanggal_transaksi" value="<?php echo $transaksi['tanggal_transaksi']; ?>">
							</div>
						</div>
						...
						<div class="row mb-3">
							...
							<div class="col-sm-5">
								<input type="text" class="form-control" name="status" value="<?php echo $transaksi['status']; ?>">
							</div>
						</div>

						<div class="row mb-3">
							<label for="hp" class="col-sm-2 col-form-label"></label>
							<div class="col-sm-5">
