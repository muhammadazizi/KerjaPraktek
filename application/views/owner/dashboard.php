		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-6">
							<?= form_error('namaBarang', '<div class="alert alert-danger" role="alert">', '</div>'); ?>
							<?= $this->session->flashdata('message'); ?>
							<a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#barangModal">Tambah Barang</a>
							<table class="table">
								<thead>
									<tr>
								...
								<tbody>
									...
									<?php foreach ($barang as $b) : ?>
										<tr>
											...
											<td><?= $b['harga']; ?></td>
											<td><?= $b['stok']; ?></td>
											<td><img src="<?= base_url('assets/img/') . $b['image']; ?>" class="card-img-top" alt=""></td>
											<td>
												<a href="<?php echo base_url(); ?>admin/edit_data1/<?php echo $b['id_barang']; ?>" class="badge rounded-pill bg-success">Edit</a>
												<a href="" class="badge rounded-pill bg-warning">Delete</a>
											</td>
										</tr>
										<?php $i++; ?>
									<?php endforeach; ?>
