		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-lg-8">
							<?= form_open_multipart('pengguna/edit');  ?>
							<div class="row mb-3">
								<br>
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nama" name="nama" value="<?= $login['nama']; ?>"> <?= form_error('nama1', '<small class="text-danger pl-3">', '</small>'); ?>
								</div>
							</div>
							<br>
							<br>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nama_belakang" name="nama_belakang" value="<?= $login['nama_belakang']; ?>"> <?= form_error('nama2', '<small class="text-danger pl-3">', '</small>'); ?>
								</div>
							</div>
							<br>
							<br>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<div class="row">
										<div class="col-sm-3">
											<img src="<?= base_url('assets/img/profil/') . $login['image'] ?>" class="img-thumbnail">
										</div>
										<div class="col-sm-9">
