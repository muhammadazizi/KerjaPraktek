		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="container-fluid">
						<h1 class="h3 mb-4 text-gray-800">Jam Tangan Wanita</h1>

						<div class="container-fluid">
							<div class="row">
								<?php foreach ($wanita as $brg) : ?>
						...
						<?php echo anchor('pengguna/genderuser', '<div class="btn btn-sm btn-danger">Kembali</div>') ?>
					</div>
				</div>
