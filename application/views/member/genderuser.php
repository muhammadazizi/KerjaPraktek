			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="container-fluid">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('kategori/pria_user'); ?>">
								<img src="<?php echo base_url('assets/img/pri.jpg'); ?>" class="card-img-top">
							</a>
						</li>

						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('kategori/wanita_user'); ?>">
								<img src="<?php echo base_url('assets/img/wan.jpg'); ?>" class="card-img-top">
							</a>
						</li>

						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('kategori/unisex_user'); ?>">
								<img src="<?php echo base_url('assets/img/uni.jpg'); ?>" class="card-img-top">
							</a>
						</li>
					</div>
				</div>
