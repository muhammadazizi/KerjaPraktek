			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('pengguna/genderuser'); ?>">
						...
						<li class="nav-item">
							<a class="nav-link" href="<?= base_url('pengguna/detail_keranjang') ?>">
								<i class="fas fa-shopping-basket text-gray-800"></i>
								<span class="text-gray-800">Keranjang</span></a>
						</li>
						...
						<li class="nav-item dropdown no-arrow">
							...
							<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
								...
								<div class="dropdown-divider"></div>
								<a class="dropdown-item" href="<?= base_url('beranda/guest'); ?>" data-toggle="modal" data-target="#logoutModal">
					...
					<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="carousel-item">
								<img src="<?php echo base_url('assets/img/bannersw.jpg'); ?>" class="d-block w-100" alt="gambar">
							</div>
							<div class="carousel-item">
							...
							<?php foreach ($barang as $brg) : ?>
								<div class="card ml-3 mb-3" style="width: 16rem;">
									...
									<div class="card-body">
										...
										<small>Kategori : <?php echo $brg->nama_kategori ?></small><br>
										<small>Deskripsi : <?php echo $brg->keterangan ?></small><br>
										<small>Stok Barang : <?php echo $brg->stok ?></small><br>
										<span class="badge bg-success mb-3" style="color: white;">Rp. <?php echo number_format($brg->harga, 0, ',', '.') ?></span><br>

										<?php echo anchor('pengguna/tambah_keranjang/' . $brg->id_barang, '<div class="btn btn-sm btn-primary">Tambah ke Keranjang</div>') ?>

										<?php echo anchor('pengguna/detail/' . $brg->id_barang, '<div class="btn btn-sm btn-success">Detail</div>') ?>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="<?= base_url('beranda/guest'); ?>">Logout</a>
				</div>
			</div>
		</div>
	</div>
