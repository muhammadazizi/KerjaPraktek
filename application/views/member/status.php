	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<!-- /.container-fluid -->
				<div class="container-fluid">
					<h1 class="h3 mb-4 text-gray-800">Status Pembayaran</h1>
					<div class="container-fluid">
						<?php foreach ($transaksi as $trk) : ?>
							<div class="card mb-3" style="max-width: 1000px;">
								<div class="row g-0">
									<div class="col-md-10">
										<div class="card-body">
											<h5 class="card-title"> <?php echo $trk->nama_user ?></h5>
											<p class="card-text"> <?php echo $trk->hp ?></p>
											<p class="card-text"> <?php echo $trk->status ?></p>
										</div>
									</div>
								</div>
							</div>
