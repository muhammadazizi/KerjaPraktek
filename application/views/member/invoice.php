			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="alert alert-success">
						<p class="text-center align-middle">Selamat Pesanan Anda Sudah Berhasil</p>
					</div>




					<form method="post" action="<?php echo base_url() ?>pengguna/status">

						<button type="submit" class="btn btn-sm btn-primary mb-3">Lanjut Melihat Status</button>
					</form>
